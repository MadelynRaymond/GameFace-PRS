    ...
    <div>
      <div className="report-card-header">
        ...
        <div className="filter-button-group">
          <button className="filter-button">Month
          </button>
          <button className="filter-button">Year
          </button>
          <button className="filter-button">Lifetime
          </button>
      </div>
      <div className="export-button-group">
        <button className="export-button">Print Icon
        </button>
        <button className="export-button">Export Icon
        </button>
      </div>
      </div>
      </div>
